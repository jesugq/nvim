do
  -- <C-b>
  vim.keymap.set('n', '<C-b>e', function() Snacks.explorer({ focus = 'input' }) end, { desc = 'Snacks explorer' })
  vim.keymap.set('n', '<C-b>w', function() Snacks.picker.buffers({ focus = 'input' }) end, { desc = 'Snacks window' })
  vim.keymap.set('n', '<C-b>r', function() Snacks.picker.recent({ focus = 'input', limit = 500, filter = { cwd = true, }, }) end, { desc = 'Snacks recent' })
  vim.keymap.set('n', '<C-b>f', function() Snacks.picker.files({ focus = 'input', hidden = true, ignored = true, }) end, { desc = 'Snacks picker files' })
  ...
  vim.keymap.set('n', '<C-b>g', function() Snacks.picker.grep({ focus = 'input', regex = false, }) end, { desc = 'Snacks picker grep' })
  vim.keymap.set('n', '<C-b>G', function() Snacks.picker.grep({ focus = 'input', regex = true, }) end, { desc = 'Snacks picker grep regex' })
  vim.keymap.set('n', '<C-b>b', function() Snacks.picker.grep_buffers({ focus = 'input', regex = false, }) end, { desc = 'Snacks picker grep buffers' })
  vim.keymap.set('n', '<C-b>B', function() Snacks.picker.grep_buffers({ focus = 'input', regex = true, }) end, { desc = 'Snacks picker grep buffers regex' })
