do
  ...
  vim.keymap.set('n', '<leader>fl', function() Snacks.picker.recent() end, { desc = 'Snacks picker git log' })
  vim.keymap.set('n', '<leader>fd', function() Snacks.picker.git_diff() end, { desc = 'Snacks picker git diff' })
  ...
  vim.keymap.set('n', '<leader>fs', function() Snacks.picker.search_history() end, { desc = 'Snacks picker search history' })
