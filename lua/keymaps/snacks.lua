do
  ...
  vim.keymap.set('n', '<leader>fp', function() Snacks.picker.files({ cwd = vim.fn.stdpath("config") }) end, { desc = 'Snacks picker config files' })
  ...
  vim.keymap.set('n', '<leader>sl', function() Snacks.picker.git_log() end, { desc = 'Snacks picker git log' })
  ...
  vim.keymap.set('n', '<leader>bc', function() Snacks.bufdelete() end, { desc = 'Snacks bufdelete' })
end
